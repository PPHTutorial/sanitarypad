 ...
 */
    return Scaffold(
      ...
      body: ListView(
        padding: EdgeInsets.all(ResponsiveConfig.spacing(20)),
        children: [
          // Header
          Card(
            color: Theme.of(context).colorScheme.surfaceContainer,
            child: Padding(
              padding: EdgeInsets.all(ResponsiveConfig.spacing(24)),
              child: Column(
                children: [
                  Icon(
                    Icons.star_rounded,
                  ...
                  SizedBox(height: ResponsiveConfig.spacing(16)),
                  Text(
                  ...
                  SizedBox(height: ResponsiveConfig.spacing(8)),
                  Text(
          ...
          SizedBox(height: ResponsiveConfig.spacing(24)),
          ...
          // Half Yearlyf
          _PricingCard(
            tier: PremiumTier.halfyearly,
            isSelected: _selectedTier == PremiumTier.halfyearly,
            currencySymbol: "USD",
            onTap: () =>
                setState(() => _selectedTier = PremiumTier.halfyearly),
            showSavings: true,
          ),
          // Yearly (Recommended)
          _PricingCard(
          ...
          ElevatedButton(
            ...
            style: ElevatedButton.styleFrom(
              padding:
                  EdgeInsets.symmetric(vertical: ResponsiveConfig.spacing(16)),
          ...
          SizedBox(height: ResponsiveConfig.spacing(12)),
...
class _FeatureItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Padding(
      padding: EdgeInsets.only(bottom: ResponsiveConfig.spacing(12)),
      child: Row(
        children: [
          Icon(
            icon,
          ...
          SizedBox(width: ResponsiveConfig.spacing(12)),
          Expanded(
            child: Column(
  ...
  Widget build(BuildContext context) {
    ...
    return Card(
      ...
      child: InkWell(
        ...
        borderRadius: BorderRadius.circular(12),
        child: Padding(
          padding: EdgeInsets.all(ResponsiveConfig.spacing(16)),
          child: Row(
            children: [
              // Radio button
              Radio<PremiumTier>(
                  ...
                  children: [
                    Row(
                      children: [
                        ...
                        if (isRecommended) ...[
                          SizedBox(width: ResponsiveConfig.spacing(8)),
                          Container(
                            padding: EdgeInsets.symmetric(
                              horizontal: ResponsiveConfig.spacing(8),
                              vertical: ResponsiveConfig.spacing(4),
                            ),
                    ...
                    if (showSavings && savings > 0) ...[
                      SizedBox(height: ResponsiveConfig.spacing(4)),
                      Text(
