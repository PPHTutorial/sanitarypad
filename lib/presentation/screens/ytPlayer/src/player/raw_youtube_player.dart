    ...
    return IgnorePointer(
      ...
      child: inapp.InAppWebView(
        ...
        initialData: inapp.InAppWebViewInitialData(
          data: player,
          encoding: 'utf-8',
          baseUrl: inapp.WebUri.uri(Uri.https('youtube-nocookie.com')),
          mimeType: 'text/html',
        ),
          ...
          inapp.UserScript(
            source: """
              (function() {
                ...
                const hideItems = () => {
                  const elements = document.querySelectorAll('.ytp-watermark, .ytp-logo, .ytp-youtube-button, .iv-click-target, .ytp-impression-link');
                  elements.forEach(el => {
    ...
    <head>
        <style>
            ...
            body {
                ...
                height: 100%;
                width: 100%;
                pointer-events: ${controller!.flags.useNativeControls ? 'auto' : 'none'};
            }
        </style>
        ...
        <script>
            ...
            function onYouTubeIframeAPIReady() {
                player = new YT.Player('player', {
                    ...
                    playerVars: {
                        'controls': ${controller!.flags.useNativeControls ? 1 : 0},
                        'playsinline': 1,
                        'enablejsapi': 1,
                        'fs': 0,
                        'rel': 0,
                    ...
                    events: {
                        onReady: function(event) {
                          ...
                          const hideItems = () => {
                            const watermark = document.querySelector('.ytp-watermark');
                            const logo = document.querySelector('.ytp-logo');
