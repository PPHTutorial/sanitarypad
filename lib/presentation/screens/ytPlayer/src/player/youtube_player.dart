...
class YoutubePlayer extends StatefulWidget {
  ...
  /// {@template youtube_player_flutter.logo}
  /// A widget to overlay effectively replacing the YouTube logo.
  /// {@endtemplate}
  final Widget? logo;
    ...
    return AspectRatio(
      ...
      child: Stack(
        ...
        children: [
          ...
          if (controller.value.playerState == PlayerState.buffering ||
          ...
          if (!controller.value.isFullScreen &&
              ...
              !controller.flags.useNativeControls &&
