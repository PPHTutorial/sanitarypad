...
import 'package:sanitarypad/services/location_search_service.dart';
import 'package:sanitarypad/services/credit_manager.dart';

class WorkoutCenterSearchScreen extends ConsumerStatefulWidget {
  const WorkoutCenterSearchScreen({super.key});

  @override
  ConsumerState<WorkoutCenterSearchScreen> createState() =>
      _WorkoutCenterSearchScreenState();
}

class _WorkoutCenterSearchScreenState
    extends ConsumerState<WorkoutCenterSearchScreen> {
  ...
  Future<void> _fetchPlaces() async {
    ...
    try {
      final results =
          await _service.findNearbyPlaces('gym', 'workout fitness center');
      if (mounted) {
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 16),
            Text(
              'This feature requires 5 credits or watching 3 ads to access nearby gyms and workout centers.',
              textAlign: TextAlign.center,
              style: ResponsiveConfig.textStyle(
                size: 16,
                      ...
                      SizedBox(
                        ...
                        child: ElevatedButton.icon(
                          onPressed: () async {
                            ...
                            if (hasCredits) {
                              await creditManager
                                  .consumeCredits(ActionType.workoutSearch);
